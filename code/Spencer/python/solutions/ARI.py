"""
Lab 6: Compute Automated Readability Index
...
equation_part1 = (character_count/word_count)*4.71 + (word_count/sentence_count)*0.5 - 21

equation = math.ceil(equation_part1)

print(f"""The ARI for dunelands.txt is {equation} This corresponds to a {ari_scale[equation]["grade_level"]} 
      Grade level of difficulty that is suitable for an average person {ari_scale[equation]["ages"]} years old.""")
